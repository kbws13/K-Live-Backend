...
public class StatisticInfoController {
    ...
    public BaseResponse<Map<String, Object>> getActualTime() {
        ...
        List<StatisticInfo> statisticInfoList = statisticInfoService.findListTotalInfo(statisticInfoQuery);
        ...
        Map<String, Integer> totalCountInfo = statisticInfoService.getTotalStatistic(null);
